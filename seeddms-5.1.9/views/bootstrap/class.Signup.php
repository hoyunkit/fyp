 ...
 * @version    Release: @package_version@
 */
class SeedDMS_View_Signup extends SeedDMS_Bootstrap_Style {
...
<?php
	...
	function show() { /* {{{ */
		...
		$this->contentStart();
                   ...
                   print '<a href="../index.php"><img src="../elib/image/logo.png" id="mainlogo"></a>';
                   
                   print '</div>';
                   print '</div>';
                   print '<div class="span12" id="maincontent-container"  style="padding:35px 100px 20px 100px;">';
