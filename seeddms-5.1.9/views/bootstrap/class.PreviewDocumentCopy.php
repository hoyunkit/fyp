...
class SeedDMS_View_PreviewDocumentCopy extends SeedDMS_Bootstrap_Style {
...
//        $this->htmlAddHeader('<script type="text/javascript" src="../elib/turnjs/extras/yepnope-2.0.0.js"></script>'."\n", 'js');
        ...
        $this->htmlAddHeader('<script type="text/javascript" src="../elib/PreviewDocumentjsCopy.js"></script>'."\n", 'js');
        $this->htmlAddHeader('<link href="../elib/PreviewDocumentCopy.css" rel="stylesheet"></link>'."\n", 'css');
        ...
        $this->htmlAddHeader('<script type="text/javascript" src="../elib/pdfjs/pdf.js"></script>'."\n", 'js');
        $this->htmlAddHeader('<script type="text/javascript" src="../elib/pdfjs/pdf.worker.js"></script>'."\n", 'js');
        $this->htmlAddHeader('<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css">'."\n", 'js');
        ...
        print '<input type="hidden" id="docid" value="'.$documentid.'">';
...
//        print'<div id="mousePoint"></div>';
        print'<flex class="h" style="flex: 1; background-color:#e6dfdf;">';
...
//        print'<div id="lockContainer" style="display:none"><input id="lockToggle" type="checkbox" data-toggle="toggle" data-on="Locked" data-off="Unlock" data-size="small"></div>';
        ...
        /*print'<div class="flex-container" style="display:none">
              ...
              //print'<div class="flipbook-viewport" style="height:600px;">';//        print'  <span style="cursor: pointer; float:left; color:black; z-index: 1; position: relative;">'
//            .'  &nbsp<span class="icon-minus-sign" title="minimize document display area" id="docClose" style="font-size:15px;"></span>'
//            .'  </span>';
        //print'  <div class="container" id="flipbook-container">';
        //print'      <div class="flipbook" id="turnjs" style="position:absolute; width: 100%;height: 100%;" dir="'.$flipDir.'">';
                       ...
                       print '<div id="pdf-main-container">
                            ...
                            <nav class="navbar custom-navbar" >
                                <div id="pdf-buttons">
                                    <div class="left-buttons">
                                        <button id="pdf-first"><i class="fa-solid fa-angles-left"></i></button>
                                        <button id="pdf-prev"><i class="fas fa-chevron-left"></i></button>
                                        <button id="pdf-next"><i class="fas fa-chevron-right"></i></button>
                                        <button id="pdf-last"><i class="fa-solid fa-angles-right"></i></button>
                                    </div>
                                    <div class="center-buttons">
                                        <button id="zoom-out" class="custom-button"><i class="icon-zoom-out"></i></button>              
                                        <button id="zoom-in" class="custom-button"><i class="icon-zoom-in"></i></button>
                                    </div>
                                    <div class="right-buttons">
                                        <button id="double-page" class="custom-button"><i class="fas fa-book-open"></i></button>
                                        <button id="add-bookmark"><i class="fa fa-bookmark" aria-hidden="true"></i></button>
                                        
                                        <div class="m-dropdown">
                                            <div id="show-bookmark" class="e-button">
                                                <i class="fa fa-book" aria-hidden="true"></i>
                                            </div>
                                            <ul class="e-list" id="bookmark-container" style="z-index: 9999;"></ul>
                                        </div>
                                        <button id="full-screen" class="fullscreen-button"><i class="fa-solid fa-expand"></i></button>
                               ...
                               <div id="canvas-wrapper">
                                    ...
                                    <div class="text-layer" id="text-layer2"></div>
                                    <div class="annotation-layer" id="annotation-layer2"></div>
                               </div>
        ...
        if ($showHighlight === 1) {
            print'<a data-id="0" id="nav-highlight">Highlight</a>';
        }
        if ($showSearch === 1) {
            print'<a data-id="1" id="nav-search">Search</a>';
        }
        /*if ($showNote === 1) {
            print'<a data-id="2">Notes</a>';
        }*/
        if ($showDict === 1) {
            print'<a data-id="3" id="nav-translate">Translate</a>';
            //print'<a data-id="4" id="nav-dict">Dict</a>';
        }
        print'</span>';

        /*print'
        <nav class="navbar custom-navbar" style:"width:100%;">
        <div class="left-buttons">
          <button id="prev" class="custom-button"><i class="fas fa-chevron-left"></i></button>
          <button id="next" class="custom-button"><i class="fas fa-chevron-right"></i></button>
        </div>
        <div class="zoom-buttons">
          <button id="zoom-in" class="custom-button"><i class="fas fa-minus"></i></button>
          <span id="zoom-percentage">zoom</span>
          <button id="zoom-out" class="custom-button"><i class="fas fa-plus"></i></button>
        </div>
        <div class="right-buttons">
          <button id="double-page" class="custom-button"><i class="fas fa-book-open"></i></button>
        </div>
        ...
        print'  <div class="container" id="flipbook-container">';
        print '<div id="page-count-container">Page <div id="pdf-current-page"></div> of <div id="pdf-total-pages"></div></div>';
        print '<input type="hidden" id="docid" value="'.$documentid.'">';
        echo  '<div class="canvas-wrapper">';
        echo      '<canvas id="cnv1" class="canvas-page responsive-canvas"></canvas>';
                echo '<div id="text-layer"></div>';
                echo '<div id="page-loader">Loading page ...</div>';
        echo      '<canvas id="cnv2" class="canvas-page responsive-canvas" style="display: none;"></canvas>'; 
        echo  '</div>';
        print'  </div>';
        print'</div>';
        echo  '<div class="progress-bar-container">';
        echo   '<div class="progress-bar"></div>';
        echo        '<span id="npages">not yet</span>';
        echo    '</div>';*/
