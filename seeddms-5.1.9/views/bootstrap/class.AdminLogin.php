 ...
 * @version    Release: @package_version@
 */
class SeedDMS_View_AdminLogin extends SeedDMS_Bootstrap_Style {
...
<?php
	...
	function show() { /* {{{ */
		...
		//$this->globalBanner();
                ...
                print '<img style="height: 92px; filter: invert(1);display: block; top: 20px;position: relative;" src="../elib/image/title.png">';
                print '</div>';
                   print '</div>';
		$this->contentStart();

                   print '<div class="span12" id="maincontent-container"  style="padding: 250px 100px 20px 100px;">';
                   print '<div style="width: 300px; margin:auto;">';
		//$this->pageNavigation(getMLText("sign_in"));
		if($msg)
			$this->errorMsg(htmlspecialchars($msg));
?>
<?php $this->contentContainerStart(); ?>
<form class="form-horizontal" action="../op/op.AdminLogin.php" method="post" name="form1" id="form">
<?php
		if ($refer) {
