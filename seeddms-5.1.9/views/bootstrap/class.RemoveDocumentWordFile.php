 ...
 * @version    Release: @package_version@
 */
class SeedDMS_View_RemoveDocumentWordFile extends SeedDMS_Bootstrap_Style {
...
?>
<form action="../op/op.RemoveDocumentWordFile.php" name="form1" method="post">
  <?php echo createHiddenFieldWithKey('removedocumentwordfile'); ?>
