 ...
 * @version    Release: @package_version@
 */
class SeedDMS_View_AddScannedFile extends SeedDMS_Bootstrap_Style {
...
<?php
	...
	function show() { /* {{{ */
		...
		$this->contentHeading(getMLText("linked_ScannedFiles"));
?>
...
<form class="form-horizontal" action="../op/op.AddScannedFile.php" enctype="multipart/form-data" method="post" name="form1" id="form1">
...
////                    $options[] = array(getMLText('version')." ".$version->getVersion());
//		}
//		$this->formField(
//			getMLText("version"),
//			array(
...
//				'options'=>$options
//			),
//                        array('field_wrap'=>array(1=>"<br>Warning: The existing word file with the same version will be deleted."))
//		);
//		$this->formField(
//			getMLText("name"),
//			array(
