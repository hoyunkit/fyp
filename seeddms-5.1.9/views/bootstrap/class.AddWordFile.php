 ...
 * @version    Release: @package_version@
 */
class SeedDMS_View_AddWordFile extends SeedDMS_Bootstrap_Style {
...
<?php
	...
	function show() { /* {{{ */
		...
		$this->contentHeading(getMLText("linked_wordFiles"));
?>
...
<form class="form-horizontal" action="../op/op.AddWordFile.php" enctype="multipart/form-data" method="post" name="form1" id="form1">
