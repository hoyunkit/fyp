 ...
 * @version    Release: @package_version@
 */
class SeedDMS_View_EditDocumentWordFile extends SeedDMS_Bootstrap_Style {
...
?>
<form action="../op/op.EditDocumentWordFile.php" class="form-horizontal" name="form1" method="post">
  <?php echo createHiddenFieldWithKey('editdocumentwordfile'); ?>
