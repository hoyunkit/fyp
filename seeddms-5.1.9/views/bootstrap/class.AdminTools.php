...
?>
	...
	<?= self::startRow(); ?>
            <?= self::rowButton("../out/out.CheckPrivilege.php?folderid=1&selUser=-1&selGroup=-1", "smile", "check_privilege"); ?>
		<?= self::rowButton("../out/out.UsrMgr.php", "user", "user_management"); ?>
		<?= self::rowButton("../out/out.GroupMgr.php", "group", "group_management"); ?>
                <?= self::rowButton("../out/out.AccessMgr.php", "key", "access_management") ?>
