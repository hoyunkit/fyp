$(document).ready(function(){
	...
	$('#turnjs').live('mousedown',function(e){
		...
		if ($('#turnjs').css('zoom')!=1) { //when turnjs zoom, grab for move
			var offset = $(this).offset();
			 var fac=parseFloat($('#turnjs').css('zoom'));
			 $(this).data("flipbkx", e.pageX*fac/1.8 -offset.left*1.8/fac);
			$(this).data("flipbky", e.pageY*fac/1.8 -offset.top*1.8/fac);
    ...
    //grab pages on right to adjust position    
       ...
       if($('#turnjs').css('zoom')==1){
        ...
        $('#flipbook-container').live('mousemove',function(e){
            ...
            if ($('#turnjs').data("flipbkx")!= null && $('#turnjs').data("flipbky")!=null&& $('#turnjs').css('zoom')!=1) {
                var fac=parseFloat($('#turnjs').css('zoom'));
                var y=e.pageY*fac/1.8 - $('#turnjs').data("flipbky")-60;
                if($(window).width()>=1278){
                    var x =e.pageX*fac/1.8 - $('#turnjs').data("flipbkx")-150;
                }else{
                    var x =e.pageX*fac/1.8 - $('#turnjs').data("flipbkx")-50;
                }
                ...
                //$('#turnjscontain').css('width',$('#maincontent-container').width()-$('#infobar').width()-parseInt($('#infobar').css('margin-left'))-2);
                 if(percent>30){
                    if($('#infobar').hasClass("span4")){
                        ...
                        $('#flipbook-container').css('width',448);
                        $('.flipbook').turn('size',448, 600);
                        pageinfotab($('.flipbook').turn('page'));
                    ...
                    if($('#infobar').hasClass("span8")){
                        ...
                        $('#flipbook-container').css('width',896);
                        $('.flipbook').turn('size',896, 600);
                        pageinfotab($('.flipbook').turn('page'));
                        $('#infobar').addClass('span4');
...
function flipbooksize(){
    ...
    var disPage=$('#singlePage').attr("value");
    
        if (win.width() >= 1278 && disPage==1) {
            ...
            if (win.width() >= 820 && $('#turnjscontain').hasClass('span12')){
                $('#flipbook-container').css('left','');
            ...
            $('#flipbook-container').css('width',448*disPage);
            $('#flipbook-container').css('height',600);
            $('.flipbook').turn('size',448*disPage, 600);
